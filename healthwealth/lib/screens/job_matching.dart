...
class AppliedJobCard extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                '${job.region} • ${job.yearsExperienceRequired}y exp required',
  ...
  Widget _buildSkillsPreview(BuildContext context) {
    final skills = job.requiredSpecializations.take(3).join(', ');
    return Text(
      'Skills: $skills${job.requiredSpecializations.length > 3 ? '...' : ''}',
      style: Theme.of(context).textTheme.bodyMedium,
    );
  }
...
class JobMatchCard extends StatelessWidget {
  ...
  Widget _buildSkillsPreview(BuildContext context) {
    final skills = scoredJob.jobApplication.requiredSpecializations.take(3).join(', ');
    return Text(
      'Skills: $skills${scoredJob.jobApplication.requiredSpecializations.length > 3 ? '...' : ''}',
      style: Theme.of(context).textTheme.bodyMedium,
    );
  }
      ...
      builder: (_, controller) => Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            _buildDetailSection('Required Specialization',
                job.jobApplication.requiredSpecializations.join(', ')),
            _buildDetailSection('Required Procedural Experience',
                job.jobApplication.requiredProcedures.join(', ')),
            _buildDetailSection('Required Certifications',
                job.jobApplication.requiredCertifications.join(', ')),
            _buildDetailSection('Conditions Treated',
                job.jobApplication.treatedConditions.join(', ')),
            SizedBox(height: 16),
            // ElevatedButton(
            //   onPressed: () {
