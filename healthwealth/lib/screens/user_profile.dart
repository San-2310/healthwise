...
class UserProfileScreen extends StatelessWidget {
  ...
  Future<Doctor> fetchUserProfile() async {
            ...
            return Padding(
              ...
              child: ListView(
                children: [
                  ...
                  BadgeDisplayRow(userId: 'lUoJzE4iXrVAvJudsCHwUwVjfPB2'),
                  SizedBox(height: 10),
                  // Role
                  ...
                  _buildList(professional.certifications),
                  SizedBox(height: 20),
                  // Industry Focus
                  _buildSectionTitle("Specializations"),
                  _buildList(professional.specializations),
                  SizedBox(height: 20),
                  // Regulatory Expertise
                  _buildSectionTitle("Procedures Mastered"),
                  _buildList(professional.procedures),
                  SizedBox(height: 20),
                  // Technical Skills
                  _buildSectionTitle("Top Conditions Treated"),
                  _buildList(professional.conditions),
                  SizedBox(height: 20),
                  // Experience & Jurisdiction
                  _buildInfoRow(Icons.location_on, "Jurisdiction: ${professional.region}"),
                  SizedBox(height: 10),
...
class _BadgeDisplayRowState extends State<BadgeDisplayRow> {
  ...
  Future<List<String>> fetchBadges() async {
    print('fetchBadges is called');
    // Query Firestore to get badges where userId matches
    QuerySnapshot snapshot = await FirebaseFirestore.instance
        .collection('badges')
        .where('userId', isEqualTo: 'lUoJzE4iXrVAvJudsCHwUwVjfPB2')
        .get();
